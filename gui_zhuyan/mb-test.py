...
if __name__ == '__main__':
	...
	try:
		...
		init_10gbe('xgbe4', '192.168.6.227', 33333, '192.168.5.127', 12345)
		init_10gbe('xgbe5', '192.168.6.227', 33334, '192.168.5.127', 12346)
		init_10gbe('xgbe6', '192.168.6.227', 33335, '192.168.5.127', 12347)
		init_10gbe('xgbe7', '192.168.6.227', 33336, '192.168.5.127', 12348)
